...
<div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
    ...
    <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form class="space-y-6" action="/connect" method="POST">
            <div>
            ...
            <div>
                <div class="flex items-center justify-between">
                    ...
                    <div class="text-sm">
                        <a href="#" class="font-semibold text-indigo-600 hover:text-indigo-500">Mots de passe oublié ?</a>
                    </div>
                </div>
                <div class="mt-2">
        ...
        <p class="mt-10 text-center text-sm text-gray-500">
            ...
            <a href="/register" class="font-semibold leading-6 text-indigo-600 hover:text-indigo-500">S'enregistrer</a>
        </p>
    </div>
</div>
